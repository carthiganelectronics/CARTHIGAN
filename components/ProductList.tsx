  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      {products.map((product) => (
        ...
        >
          <CardBody className={`bg-white dark:bg-gray-800 relative group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] w-auto sm:w-[30rem] h-auto rounded-xl p-6 border ${product.id === 2 ? 'cursor-pointer border-uganda-red/20' : 'border-black/[0.1]'}`}>
            <CardItem
              translateZ="50"
